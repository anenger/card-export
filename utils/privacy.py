...
class PrivacySession:
    ...
    def login(self, sessionid, username, password):
        ...
        r = requests.post('https://privacy.com/auth/local',
        ...
        if (r.status_code == 200):
            ...
            print(str(r.status_code) +
                  ': Bad response when posting login form - ' + r.text)
    ...
    def getTransactions(self):
        ...
        r = requests.get('https://privacy.com/api/v1/transaction',
    ...
    def getCards(self):
        ...
        print('Getting cards...')
        r = requests.get('https://privacy.com/api/v1/card',
                         cookies=cookies, headers=headers)
